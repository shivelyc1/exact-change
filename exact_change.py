...
def CalcDenominationQuantity(dollarAmount: float, currencyValue: DenominationValues ):
...
def CalculateExactChange(dollarAmount: float) :
  """This function will calculate the exact amount of denominations to return for the dollarAmount.

  Parameters:
    dollarAmount (float): The dollar amount (2 decimal places) to calculate denominations for. 
  
  
  Returns: dictionary of denominations and the amount of each to equal the dollarAmount.
  """
  return 